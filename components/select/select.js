...
var SelectOptions = require("./select-options.js");
var emitter = require("../mixins/emitter.js");
var Clickoutside = require("../directives/clickoutside.js");
...
module.exports = Vue.extend({
    ...
    watch: {
        ...
        query: function (newVal) {
            ...
            var _op = this.getOptionObj(newVal);
            if(!_op){
                this.selected = null;
                this.currentValue = '';
                this.$emit('input', '');
    ...
    methods: {
        ...
        getOptionObj: function(value){
            var obj = this.options.filter(function(option){return option.value === value})[0];
            return obj;
        },
        ...
        setSelectedOption: function(){
            if(!this.multiple){
                ...
                var option = this.getOptionObj(this.value);
                if(option){
