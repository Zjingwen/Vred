  ...
  methods: {
    ...
    setClockPointer: function(radian) {
      ...
      if (typeof radian === 'undefined') {
        let unit = this.dial === 0 ? 15 : (this.dial < 3 ? 6 : 30);
    ...
    tickMouseDown: function(e, space) {
      ...
      // 圆心
      let x0 = plate.offsetLeft + this.dialRadius + clockEl.offsetLeft;
      let y0 = plate.offsetTop + this.dialRadius + clockEl.offsetTop;
