 ...
 */
require("./popover.css");
var template = require("./popover.html");
var vuePopper = require("../util/vue-popper.js");
var $ = require("../util/dom.js");
    ...
    mounted: function(){
        ...
        if (this.trigger === 'click') {
            ...
            if ([].slice.call(reference.children).length) {
                ...
                for (var i = 0; i < len; i++) {
                    if (children[i].nodeName === 'INPUT' ||
                        ...
                        on(children[i], 'focus', function(){ this.showPopper = true; }.bind(this));
                        on(children[i], 'blur', function() { this.showPopper = false; }.bind(this));
                        found = true;
                        break;
                    }
                }
            ...
            if (reference.nodeName === 'INPUT' ||
                ...
                $.on(reference, 'focus', function() { this.showPopper = true; }.bind(this));
                $.on(reference, 'blur', function() { this.showPopper = false; }.bind(this));
            } else {
                $.on(reference, 'mousedown', function(){ this.showPopper = true; }.bind(this));
                $.on(reference, 'mouseup', function() { this.showPopper = false; }.bind(this));
            }
        }
    },
