...
var cutImage = require('../cutImage/cutImage.js');
...
var upload = Vue.extend({
    ...
    methods:{
        uploadImageInit: function(){
            var vm = this;
            var id = "image-upload-" + this.type + "-" + this.mid;
            var uploadHost = 'http://upload.lanlanlife.com';
            var imageFormData;
            if(this.opts.cover){
                imageFormData = {
                    imageKey:'image',
        ...
        imageCutBlurInit: function(){
            ...
            //var obj = {};
            var imgId = "cut-image-"+ this.type + "-" + this.mid;
        ...
        transformImageInit: function(){
            ...
            var _img1W = _image.width;
            var _img1H = _image.height;

            _image.src = imageObj2.src;
            var _img2W = _image.width;
            var _img2H = _image.height;

            var rate1 = _img1W/_img1H;
            var rate2 = _img2W/_img2H;
            var w,h,x,y;
            //裁剪第一张
